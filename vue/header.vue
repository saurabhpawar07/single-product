            ...
            <div class="container">
                ...
                <div class="topbar-text text-nowrap d-none d-md-inline-block">
                    <span v-if="account.Mobile">
                        <i class="ci-support"></i><span class="text-muted me-1">Support</span><a class="topbar-link"
                            :href="'tel:'+account.Mobile">{{account.Mobile}}</a>
                    </span>
                </div>
                <div class="tns-carousel tns-controls-static d-none d-md-block" style="width: 50%; text-align: center;">
                    <div id="top_tns_controls_container" class="tns-controls" aria-label="Carousel Navigation"
                        tabindex="0">
                    ...
                    <tiny-slider id="top_tns" v-if="TopNotificationBarItems.length" :loop="true" items="1" :nav="false"
                        controlsContainer="#top_tns_controls_container" :autoplay="true" :autoplayButtonOutput="false">
                        <div v-for="(item, index) in TopNotificationBarItems" class="topbar-text tns-item"
                            id="'top_tns-item' + index">
                ...
                <div class="ms-3 text-nowrap">
                    <router-link to="/user/orders" class="topbar-link me-4 d-none d-md-inline-block"
                        href="order-tracking.html"><i class="ci-location"></i>Order tracking</router-link>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ps-2">
                                                    ...
                                                    <div class="widget-product-meta">
                                                        <span
                                                            class="text-accent me-2"><span>$</span>{{item.Cost}}<small>.00</small></span><span
                                    ...
                                    <div class="d-flex flex-wrap justify-content-between align-items-center py-3">
                                        <div class="fs-sm me-2 py-2">
                                            <span class="text-muted">Subtotal:</span><span
                                                class="text-accent fs-base ms-1"><span>$</span>{{cart_cost_total}}<small>.00</small></span>
                                        </div>
